...
<div class="flex">
    ...
    <div class="border p-4 w-40 relative h-full">
        ...
        <div class="flex justify-between items-center cursor-pointer" onclick="toggleDropdown('categoryDropdown')">
        ...
        <div class="flex justify-between items-center cursor-pointer mt-4" onclick="toggleDropdown('brandDropdown')">
        ...
        <div id="brandDropdown" class="divide-y divide-gray-200 hidden text-center">
           <a href="men_casual.jsp" style="text-decoration:none; color:black;" class="py-2">Puma</a>
            <hr class="my-2">
            <a href="men_sandal.jsp" style="text-decoration:none; color:black;" class="py-2">Campus</a>
            <hr class="my-2">
        </div>
    </div>
        ...
        <div class="container mx-auto mt-10">
            <div class="p-3 rounded-lg">
                <div class="grid grid-cols-5 gap-4">
                    ...
                    List<ProductDtls> list = dao.getmencasual();
