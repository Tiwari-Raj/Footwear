...
<img src="All_Component/image/kid12.png" style="width:100%; height:250px;">
...
<div class="flex">
    ...
    <div class="border p-4 w-40 relative h-full">
        ...
        <div id="categoryDropdown" class="divide-y divide-gray-200 hidden text-center">
            <a href="kids_running.jsp" style="text-decoration:none; color:black;" class="py-2 text-black">Running</a>
            <hr class="my-2">
            <a href="kids_sport.jsp" style="text-decoration:none; color:black;" class="py-2">Sports</a>
            <hr class="my-2">
            <a href="kids_casual.jsp" style="text-decoration:none; color:black;" class="py-2">Casual</a>
            <hr class="my-2">
            <a href="kids_sandal.jsp" style="text-decoration:none; color:black;" class="py-2">Sandal</a>
            <hr class="my-2">
            <a href="kids_slipper.jsp" style="text-decoration:none; color:black;" class="py-2">Slipper</a>
            <hr class="my-2">
        </div>
        ...
        <div class="container mx-auto mt-10">
            <div class="p-3 rounded-lg">
                <div class="grid grid-cols-5 gap-4">
                    ...
                    List<ProductDtls> list = dao.getkidsrunning();
