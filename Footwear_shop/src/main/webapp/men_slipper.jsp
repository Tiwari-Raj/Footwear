    ...
    <div class="border p-4 w-40 relative h-full">
       ...
       <div id="categoryDropdown" class="divide-y divide-gray-200 hidden text-center">
        ...
        <div id="brandDropdown" class="divide-y divide-gray-200 hidden text-center">
            <a href="men_puma.jsp" style="text-decoration:none; color:black;" class="py-2">Puma</a>
            <hr class="my-2">
            <a href="men_campus.jsp" style="text-decoration:none; color:black;" class="py-2">Campus</a>
            <hr class="my-2">
        </div>
    </div>
        ...
        <div class="container mx-auto mt-10">
            <div class="p-3 rounded-lg">
                <div class="grid grid-cols-5 gap-4">
                    ...
                    List<ProductDtls> list = dao.getmenslipper();
